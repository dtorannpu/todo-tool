            ...
            <div className='w-full max-w-xl'>
                <form onSubmit={handleSubmit(onSubmit)} className='bg-white shadow-md px-8 pt-6 pb-8 mb-4'>
                    <div className='mb-4'>
                        ...
                        <input {...register("title", { required: true, maxLength: 128 })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight" />
                    ...
                    <div className='mb-4'>
                        ...
                        <textarea {...register("description", { required: true, maxLength: 1024 })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight"></textarea>
                    ...
                    <div className='flex items-center justify-between'>
                        <input type="submit" value="更新" disabled={!isValid} className="bg-blue-500 disabled:bg-blue-300 hover:enabled:bg-blue-700 text-white font-bold py-2 px-4 rounded" />
                    </div>
                </form>
            </div>
